...
class AMATISApplication:
    ...
    def __init__(self) -> None:
        ...
        # Core components
        self._event_bus: Optional[HardenedEventBusV2] = None
        self._orchestrator: Optional[Orchestrator] = None
        
        # Data layer
        self._data_provider: Optional[AlpacaDataProvider] = None
        
        # Signal layer
        self._signal_pipeline: Optional[SignalPipeline] = None
        self._momentum_engine: Optional[MomentumEngine] = None
        self._news_engine: Optional[NewsSignalEngine] = None
        
        # Risk layer
        self._risk_engine: Optional[RiskEngine] = None
        
        # Execution layer
        self._order_manager: Optional[HardenedOrderManager] = None
    ...
    async def _handle_signal(self, event) -> None:
        ...
        try:
            ...
            logger.info(
                f"Processing signal: {symbol_str} {direction_str} (conf: {confidence:.2f})"
            )
