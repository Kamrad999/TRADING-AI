...
class OrderStateMachine:
    ...
    def transition_to_validated(self, validation_data: Optional[Dict] = None) -> bool:
        """Transition to VALIDATED state."""
        return self.transition(OrderState.VALIDATED, validation_data)
    
    def transition_to_submitted(self, broker_order_id: Optional[str] = None) -> bool:
    ...
    def transition_to_rejected(self, reason: str, error_code: Optional[str] = None) -> bool:
