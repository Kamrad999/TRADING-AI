...
class Strategy(ABC):
    ...
    @abstractmethod
    async def on_market_data(self, ohlcv: OHLCV) -> Signal | None:
    ...
    @abstractmethod
    async def on_signal(self, signal: Signal) -> Signal | None:
...
def create_symbol(ticker: str, exchange: str | None = None) -> Symbol:
